...
//deverá ser impressa a mensagem “Fora de intervalo”. O símbolo ( representa "maior que". Por exemplo:
...
int main(){
    ...
    else if(25 < valor && 50 >= valor){
        printf("Intervalo (25,50]\n");
    }
    else if(50 < valor && 75 >= valor){
        printf("Intervalo (50,75]\n");
    }
    else if(75 < valor && 100 >= valor){
